...
var BodyCell = React21.memo(function(props) {
  ...
  var createElement22 = function createElement23() {
    ...
    if (selectionMode) {
      ...
      var rowEditorSaveIcon = IconUtils.getJSXIcon(props.rowEditorSaveIcon || React21.createElement(CheckIcon, rowEditorSaveIconProps), _objectSpread$a({}, rowEditorSaveIconProps), {
        props
      });
      var rowEditorCancelIcon = IconUtils.getJSXIcon(props.rowEditorCancelIcon || React21.createElement(TimesIcon, rowEditorCancelIconProps), _objectSpread$a({}, rowEditorCancelIconProps), {
        props
      });
      var rowEditorInitIcon = IconUtils.getJSXIcon(props.rowEditorInitIcon || React21.createElement(PencilIcon, rowEditorInitIconProps), _objectSpread$a({}, rowEditorInitIconProps), {
        props
      });
      if (editingState) {
        rowEditorProps = {
  ...
  return getVirtualScrollerOption("loading") ? createLoading() : createElement22();
});
  ...
  var createContent = function createContent2() {
    return props.columns.map(function(col, i) {
      if (shouldRenderBodyCell(props.value, col, props.index)) {
        ...
        return React21.createElement(BodyCell, {
          hostName: props.hostName,
          key,
  ...
  var onRowDragOver = function onRowDragOver2(e) {
    ...
    if (draggedRowIndex.current !== index) {
      ...
      if (pageY < rowMidY) {
        ...
        if (index + 1 !== draggedRowIndex.current)
...
var DataTable = React21.forwardRef(function(inProps, ref) {
  ...
  var _React$useState19 = React21.useState(props.rows), _React$useState20 = _slicedToArray3(_React$useState19, 2), d_rowsState = _React$useState20[0], setD_rowsState = _React$useState20[1];
  var _React$useState21 = React21.useState({}), _React$useState22 = _slicedToArray3(_React$useState21, 2), d_filtersState = _React$useState22[0], setD_filtersState = _React$useState22[1];
  var metaData = {
    props,
    state: {
      first: firstState,
