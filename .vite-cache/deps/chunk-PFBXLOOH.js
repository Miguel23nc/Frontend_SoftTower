...
var Portal = React10.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React10.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var SvgIcon = React14.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React14.isValidElement(children) && children.type === "svg";
  const ownerState = {
    ...props,
    color,
    component,
  ...
  return (0, import_jsx_runtime11.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children.props.children : children, titleAccess ? (0, import_jsx_runtime11.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime12.jsx)(SvgIcon_default, {
...
var OutlinedInput = React21.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime18.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime18.jsxs)(React21.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormLabel = React22.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsxs)(FormLabelRoot, {
    ...
    ref,
    ...other,
    children: [children, fcs.required && (0, import_jsx_runtime19.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
true ? MenuList.propTypes = {
   ...
   * @default false
   */
  autoFocusItem: import_prop_types21.default.bool,
  /**
...
var Modal = React29.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime25.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime25.jsx)(BackdropSlot, {
        ...backdropProps,
        ref: backdropRef
      }) : null, (0, import_jsx_runtime25.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
//# sourceMappingURL=chunk-PFBXLOOH.js.map
